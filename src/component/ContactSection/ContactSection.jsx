        ...
        <>
            <Container className="sectionDefaultMargin">
                ...
                <Row>
                    ...
                    <Col lg={5}>
                        <Card className={style.contactContentCard}>
                            <Card.Body>
                                <div className="px-md-3 py-4">
                                    <h4 className="fw-bold pb-3">GET IN TOUCH WITH ME</h4>
                                    <hr className="pb-4 mb-0" />
                                    <div className="mb-4">
                                        <IoMailOutline style={{ fontSize: "30px" }} className=" me-3" />
                                        <a target="_blank" className="text-decoration-none" href="mailto:g.shanto18@gmail.com" style={{ fontSize: "20px" }}>g.shanto18@gmail.com</a>
                                    </div>

                                    <div className="mb-4">
                                        <IoIosLink style={{ fontSize: "30px" }} className=" me-3" />
                                    ...
                                    <div className="mb-4">
                                        <FaFacebookF style={{ fontSize: "30px" }} className=" me-3" />
                                        <a target="_blank" href="https://www.facebook.com/g.shanto18" className="text-muted text-decoration-none" style={{ fontSize: "20px" }}>www.facebook.com/g.shanto18</a>
                                    </div>

                                    <div className="mb-4 d-flex">
                                        <FaLinkedinIn style={{ fontSize: "30px" }} className=" me-3" />
                                        <div>
                                            <a target="_blank" href="https://www.linkedin.com/in/muhammad-sabbir-hossain/" className="text-muted text-decoration-none" style={{ fontSize: "20px" }}>www.linkedin.com/in/muhammad-sabbir-hossain/</a>
                                        </div>
                                    </div>

                                    <div className="mb-4 d-flex">
                                        <IoLocationSharp style={{ fontSize: "30px" }} className=" me-3" />
                                        <div>
